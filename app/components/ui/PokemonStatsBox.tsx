...
export default function PokemonStatsBox({
  ...
  const positionStyles = isTopRight 
    ? "-top-20 left-1/2 transform -translate-x-1/2 z-25 sm:-top-25 sm:-right-35 sm:left-auto sm:transform-none" 
    : "-bottom-20 left-1/2 transform -translate-x-1/2 z-35 sm:-bottom-25 sm:left-20";

  return (
    <div
      className={`absolute ${positionStyles} bg-[#fff8dcf2] border-3 border-[#8B4513] rounded-lg p-2 min-w-[200px] shadow-lg`}
    >
      <div className="font-jersey text-2xl text-zinc-800 capitalize">
