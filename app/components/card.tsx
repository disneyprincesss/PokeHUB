...
function PokemonCardComponent({ pokemon }: { pokemon: PokemonListItem }) {
  ...
  return (
    <div>
      <div className="w-full max-w-32 cursor-pointer rounded-2xl h-auto min-h-45 flex flex-col px-2 py-3 logo transition-transform hover:scale-105 hover:-translate-y-1">
